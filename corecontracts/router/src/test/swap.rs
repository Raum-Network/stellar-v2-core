...
impl<'a> RaumFiRouterTest<'a> {
    fn new() -> Self {
        ...
        let router = RaumFiRouterClient::new(&env, &env.register_contract(None, RaumFiRouter {}));
...
#[test]
pub fn initialize() {
    let router_test = RaumFiRouterTest::new();
...
pub fn mock_auth_add_liquidity_new_token() {
    ...
    let get_factory_client = factory::RaumFiFactoryClient::new(&router_test.env, &get_factory);
