use crate::test::{RaumFiRouterTest, RaumFiPairClient};
...
use soroban_sdk::{
    ...
    fn test_remove_liquidity_liquidity_negative() {
        ...
        assert_eq!(result, Err(Ok(RouterErrorsForLibrary::RouterNegativeNotAllowed)));
    }
...
fn test_remove_liquidity_deadline_expired() {
    ...
    assert_eq!(
        result,
        Err(Ok(RouterErrorsForLibrary::RouterDeadlineExpired))
    );
}
...
fn test_remove_liquidity_pair_does_not_exist() {
    ...
    assert_eq!(result, Err(Ok(RouterErrorsForLibrary::RouterPairDoesNotExist)));
}
...
fn test_remove_liquidity_sufficient_amount() {
    ...
    let expected_liquidity: i128 = 14142135523;
    ...
    // (10000000000 * 14142135523) / 14142135623 = 9999999929
    let expected_to_remove_0 = 9999999929;

    // (20000000000 * 14142135523) / 14142135623 = 1999999986;
    let expected_to_remove_1 = 1999999986;
...
fn test_remove_liquidity_sufficient_amount_inverse() {
    ...
    let amount_0: i128 = 10_000_000_000;
    let amount_1: i128 = 20_000_000_000;
    let expected_liquidity: i128 = 14142135523;//14142135623,7 - 1000;
...
fn test_remove_liquidity_insufficient_a_amount() {
    ...
    assert_eq!(
        result,
        Err(Ok(RouterErrorsForLibrary::RouterInsufficientAAmount))
    );
}
...
fn test_remove_liquidity_insufficient_b_amount() {
    ...
    let expected_to_remove_0 = 9999999929;
    let expected_to_remove_1 = 19999999999;
    // let expected_to_remove_1 = 19999999858;
    ...
    assert_eq!(
        result,
        Err(Ok(RouterErrorsForLibrary::RouterInsufficientBAmount))
    );
}
